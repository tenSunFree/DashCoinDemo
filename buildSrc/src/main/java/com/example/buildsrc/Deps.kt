...
import com.example.buildsrc.Version.androidx_lifecycle
import com.example.buildsrc.Version.compose_version
import com.example.buildsrc.Version.hilt_version
import com.example.buildsrc.Version.kotlinx_coroutines
import com.example.buildsrc.Version.play_services_auth_version
import com.example.buildsrc.Version.room_version
    ...
    object AndroidX {
        ...
        object Lifecycle {
            ...
            const val viewModelKtx =
                "androidx.lifecycle:lifecycle-viewmodel-ktx:$androidx_lifecycle"
            const val runtimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:$androidx_lifecycle"
            const val viewModelCompose =
                "androidx.lifecycle:lifecycle-viewmodel-compose:$androidx_lifecycle"
        }
    ...
    object Google {
        ...
        object AndroidGms {
            const val playServicesAuth =
                "com.google.android.gms:play-services-auth:$play_services_auth_version"
        }
        ...
        object Jetbrains {
            object Kotlinx {
                ...
                const val coroutineAndroid =
                    "org.jetbrains.kotlinx:kotlinx-coroutines-android:$kotlinx_coroutines"
                const val coroutinePlayServices =
                    "org.jetbrains.kotlinx:kotlinx-coroutines-play-services:$kotlinx_coroutines"
